    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('dashboard.edit_category') }}</h3>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name_ar" class="form-control" name="name[ar]" value="{{ old('name.ar', $category->getTranslation('name', 'ar'))}}">
                                                        @error('name.ar')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name_en" class="form-control" name="name[en]" value="{{ old('name.en', $category->getTranslation('name', 'en'))}}">
                                                        @error('name.en')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="d-inline-block custom-control custom-checkbox">
                                                        ...
                                                        <input type="checkbox" class="custom-control-input" id="status" name="status" value="1" {{ old('status', $category->status) == 1 ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="status">{{ __('dashboard.active') }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <input type="hidden" id="id" class="form-control" name="id" value="{{ $category->id}}">
