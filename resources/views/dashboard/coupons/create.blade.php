    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('dashboard.add_coupon') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('dashboard.add_coupon') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-11 col-lg-10">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('dashboard.coupons.store')}}" method="post">
                                        @csrf
                                        <div class="form-body">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" id="code" class="form-control" name="code" value="{{ old('code') }}" placeholder="{{ __('dashboard.code_placeholder') }}" style="text-transform: uppercase;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="number" id="discount_percentage" class="form-control" name="discount_percentage" min="1" max="100" value="{{ old('discount_percentage', 10) }}">
                                                                    <div class="input-group-append">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" id="start_date" class="form-control" name="start_date" value="{{ old('start_date', date('Y-m-d')) }}">
                                                                @error('start_date')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" id="end_date" class="form-control" name="end_date" value="{{ old('end_date', date('Y-m-d', strtotime('+30 days'))) }}">
                                                                @error('end_date')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" id="limit" class="form-control" name="limit" min="1" value="{{ old('limit', 100) }}">
                                                                @error('limit')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="coupon-ticket clearfix">
                                                            <div class="coupon-main-content">
                                                                ...
                                                                <div class="coupon-preview-code-wrapper">
                                                                    <span class="coupon-preview-code" id="preview-code">{{ old('code') ?: 'WELCOME30' }}</span>
                                                                </div>
                                                                <div class="coupon-preview-dates">
                                                                    <i class="la la-calendar"></i>
                                                                    <span>{{ __('dashboard.valid_from') }} </span><strong id="preview-start">{{ old('start_date', date('Y-m-d')) }}</strong><br>
                                                                    <span> {{ __('dashboard.valid_to') }} </span><strong id="preview-end">{{ old('end_date', date('Y-m-d', strtotime('+30 days'))) }}</strong>
                                                                </div>
                                                            </div>
                                                            <div class="coupon-divider"></div>
                                                            <div class="coupon-side-content">
                                                                <div class="coupon-preview-label">{{ __('dashboard.discount_value') }}</div>
                                                                <div class="coupon-preview-value" id="preview-value">{{ old('discount_percentage', 10) }}%</div>
                                                                <span class="coupon-preview-badge" id="preview-limit">{{ __('dashboard.limit_label') }} {{ old('limit', 100) }} {{ __('dashboard.times') }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    $(document).ready(function() {
        ...
        function updateCouponPreview() {
            ...
            // تحديث كود الكوبون
            if (code === '') {
                $('#preview-code').text('WELCOME30').css('opacity', '0.5');
            } else {
