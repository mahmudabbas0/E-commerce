...
@section('title', __('dashboard.add_faq'))
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('dashboard.add_faq') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('dashboard.add_faq') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content-body">
            <section id="add-faq">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-10">
                        <form class="form" action="{{route('dashboard.faqs.store')}}" method="post">
                            @csrf
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <div class="position-relative has-icon-left">
                                                    <textarea id="question_ar" class="form-control" name="question[ar]" rows="2" placeholder="{{ __('dashboard.question_ar') }}">{{ old('question.ar') }}</textarea>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="position-relative has-icon-left">
                                                    <textarea id="answer_ar" class="form-control" name="answer[ar]" rows="4" placeholder="{{ __('dashboard.answer_ar') }}">{{ old('answer.ar') }}</textarea>
                                                    <div class="form-control-position">
                                ...
                                <div class="card" id="faq-english">
                                    ...
                                    <div id="accordionEn" role="tabpanel" aria-labelledby="headingEn" class="card-collapse collapse" aria-expanded="false">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <div class="position-relative has-icon-left">
                                                    <textarea id="question_en" class="form-control" name="question[en]" rows="2" placeholder="{{ __('dashboard.question_en') }}">{{ old('question.en') }}</textarea>
                                                    <div class="form-control-position">
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="position-relative has-icon-left">
                                                    <textarea id="answer_en" class="form-control" name="answer[en]" rows="4" placeholder="{{ __('dashboard.answer_en') }}">{{ old('answer.en') }}</textarea>
                                                    <div class="form-control-position">
