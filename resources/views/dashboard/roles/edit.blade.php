                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group border-bottom-0">
                                                        ...
                                                        <input type="text" id="role_en" class="form-control" name="role[en]" value="{{ old('role.en', $role->getTranslation('role', 'en')) }}" placeholder="e.g. Administrator">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group border-bottom-0">
                                                        <label for="role_ar">{{ __('dashboard.role-name') }} (AR)</label>
                                                        <input type="text" id="role_ar" class="form-control" name="role[ar]" value="{{ old('role.ar', $role->getTranslation('role', 'ar')) }}" placeholder="مثال: مسؤول">
                                                    </div>
                                                </div>
                                            </div>
