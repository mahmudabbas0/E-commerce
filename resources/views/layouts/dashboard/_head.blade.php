...
<link rel="stylesheet" type="text/css" href="{{asset('vendor/fileinput/css/fileinput.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('vendor/fileinput/themes/fa5/theme.min.css')}}">
